...
public class Main {
	...
	public static void CheckEstado(Moto moto1) { // Deberia ser un Metodo de Conductor o Piloto
												 //Tiene mas sentido que sea de CONDUCTOR puesto a que
		if (moto1.isEstado_moto()) {		 	// esa clase tiene mas sentido que sea Padre
	...
	public static void EncenderMoto(Moto moto1) { // Deberia ser un Metodo de Conductor o Piloto
	...
	public static void CheckCombustible(Moto moto1) { // Deberia ser un Metodo de Conductor o Piloto
	...
	public static void CargarCombustible(Moto moto1) { // Deberia ser un Metodo de Conductor o Piloto
	...
	public static void ConducirMotoConductor(Moto moto1,Conductor conductor) { //Metodo de Conductor
														//en este caso por como estan hechas las clases
		if (moto1.isEstado_moto()==true) {
			...
			if (moto1.getCombustible()!=0) {
				...
				conductor.setVel_conductor((int)(Math.random()*70)+31); //Mejor haberlo definido en su clase y no en un metodo
	...
	public static void ConducirMotoPiloto(Moto moto1,Piloto piloto) {	//Metodo de Piloto por como estan hechas las clases
		...
		if (moto1.isEstado_moto()==true) {
			...
			if (moto1.getCombustible()!=0) {
				...
				piloto.setVel_piloto((int)(Math.random()*140)+31); //Mejor haberlo definido en su clase y no en un metodo
